---
name: ghost-check
description: Validação anti-IA de qualquer texto antes de sair. Audita texto PT-PT contra 40+ padrões de AI-slop — palavras proibidas, frases-template, formatação suspeita, ritmo uniforme. Reescreve para soar humano e com a tua voz. Usar antes de publicar posts LinkedIn, enviar cold mail, ou entregar qualquer output textual público.
---

# /ghost-check — Anti-IA Gate

Última linha de defesa antes de qualquer texto sair em teu nome. Baseado em `conorbronsdon/avoid-ai-writing` v3.3.1 + adaptação PT-PT + a tua voz.
...
Detecta todos os AI-isms → reescreve em PT-PT humano → mostra mudanças principais → **loop de self-critique**.
...
| Contexto | Rigor | Foco |
|---|---|---|
| Post LinkedIn | 🔴 Máximo | A tua voz, variação de ritmo, zero slop |
| Cold mail | 🔴 Máximo | Curto, específico, zero template phrases |
...
- **Antes de qualquer publicação** com o teu nome em cima
- **Em cada variante** de um texto que vai para fora, não só na primeira
- **Nos textos que um agente escreveu por ti**, sobretudo quando ficaram bons à primeira
- **Emparelhado com `/fact-check`:** este trata do estilo, o outro trata da verdade. Correr os dois

Regra de desenho: quem escreve não deve ser quem avalia. Se o mesmo agente gera e aprova, aprova
sempre. Correr o gate em passo separado é o que o torna útil.
